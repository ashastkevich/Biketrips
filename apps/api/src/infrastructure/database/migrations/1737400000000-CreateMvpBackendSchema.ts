  ...
  async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      CREATE TABLE trips (
        ...
        asphalt_percent integer NOT NULL CHECK (asphalt_percent BETWEEN 0 AND 100),
        unpaved_percent integer NOT NULL CHECK (unpaved_percent BETWEEN 0 AND 100),
        unpaved_surface_details text[] NOT NULL DEFAULT '{}',
        CHECK (asphalt_percent + unpaved_percent = 100),
